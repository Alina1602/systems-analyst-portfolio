...
[Материалы работы](ссылка)### Постановка и приёмка задач в разработку
...
**Что сделала:**
- Разобрала четыре Use Case и выявила ошибки в спецификациях:
  взаимоисключающие ветви оформлены как последовательные шаги,
  точки расширения не совпадают по содержанию с альтернативными
  сценариями, расширения вставлены в основной поток, предусловие
  сформулировано через интерфейс, отсутствуют постусловия,
  не описана обработка неполного обеспечения запчастями
- Подготовила исправленные версии всех четырёх Use Case
- Оформила 4 задачи в разработку в формате JIRA: контекст, связь
  с вышестоящей задачей, предусловия, окружение, ключевые источники
  информации, НФТ, описание решения, критерии готовности постановки
  (DoR), критерии проверки и критерии готовности решения (DoD)
- Разработала тест-кейсы с разделением Happy Path, альтернативных
  и негативных сценариев
- Смоделировала два дефекта и оформила отчёты о них

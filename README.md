...
**Задача:** описать процесс и структуру системы в разных нотациях UML.

**Что сделала:**
- Activity-диаграмма процесса "Заказ запчастей"
- ![Activity-диаграмма процесса "Заказ запчастей"](https://otus.ru/redirect/?to=https%3A%2F%2Fdrive.google.com%2Ffile%2Fd%2F1XBLLhqrDHT7iWucLZIYR-Boe59GiesFu%2Fview%3Fusp%3Dsharing)
- Диаграмма классов на основе ER-модели: выделила методы объектов,
  отношения композиции и ассоциации


![Диаграмма классов](class-diagram.png)


**Разница между ER-моделью и диаграммой классов:** ER описывает
структуру хранения данных, диаграмма классов — объекты системы
с их поведением (методами) и отношениями наследования и композиции.
